    ...
    <div class="form-grid">
        ...
        <div class="form-group">
            ...
            <input type="date" id="buy_date" name="buy_date"
                value="{{ old('buy_date', $car->buy_date) }}">
        ...
        <div class="form-group">
            ...
            <div class="document-checkbox-group">
                @foreach([
                    ...
                    <label>
                        <input type="checkbox" name="document_in_stock[]"
                            value="{{ $key }}"
        ...
        <div class="form-group">
            ...
            <select id="sale_status" name="sale_status">
                <option value="">-- Chọn --</option>
                <option value="0" {{ old('sale_status', $car->sale_status) == 0 ? 'selected' : '' }}>Trong kho</option>
                <option value="1" {{ old('sale_status', $car->sale_status) == 1 ? 'selected' : '' }}>Đã bán</option>
                <option value="2" {{ old('sale_status', $car->sale_status) == 2 ? 'selected' : '' }}>Đã đặt</option>
            </select>
