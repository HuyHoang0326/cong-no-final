            ...
            <form id="invoiceForm" method="POST" action="{{ route('invoices.store') }}">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $nextCode }}" class="invoice-id" name="code" id="code" disabled style="background-color: rgb(212, 212, 212)">
                    ...
                    <div class="form-group customer-group">
                        ...
                        <div class="field-customer form-group">
                            <input type="text" placeholder="Chọn khách hàng" class="customer-name" name="customer_name"
                                id="customer_name">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Tên người nhận" class="receiver-name" name="receiver_name"
                            id="receiver_name">
                    ...
                    <div class="debt-box">
                        ...
                        <table class="invoice-table">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <input type="number" placeholder="Nhập tiền đã thanh toán" class="paid-amount"
                        ...
                        <table class="invoice-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="total-sale format-number" readonly name="price"
                                            id="price">
                                    </td>
                                    <td>
